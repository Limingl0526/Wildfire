...
def simulate_land_use(map, population_map, risk_map, steps, size=(640, 873), experiment=0):
    for step in range(steps):
        ...
        print(f"Burned cells in experiment {experiment + 1}, step {step + 1}: {count_burned_cells}:")
...
for experiment in range(num_experiments):
    ...
    map_clone = initial_map.copy()
    population_map_clone = initial_population_map.copy()
    final_map = simulate_land_use(map_clone, population_map_clone, risk_map, steps, size, experiment)
